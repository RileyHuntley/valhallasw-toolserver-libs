...
pages = Q.do("select page_title from nlwiki_p.page join nlwiki_p.categorylinks on page_id =cl_from where cl_to='Wikipedia:werk_in_uitvoering' and page_namespace=0")
